 ...
 * Алгоритм
 * ============
 * Создать массив с заданиями. Постарайтесь создать массив длины больше 30 и обязательно добавьте туда задания всех типов.
 * (Вы же помните, что это можно реализовать с помощью цикла?)
 * Создать массив со студентами. Предварительно вам нужно создать парочку менторов, чтобы было кому проверять
 * 3адания ваших студентов.
 * В цикле, пока все студенты не закончат решать все задачи:
 * ➜ Рандомно выбираете количество задач, которые необходимо решить.
 * ➜ Выбираете студента (это может быть вложенный цикл) и вызываете его метод Решить задачи. Обратите внимание, что, если студент уже прорешал все задачи,
 * то вам нужно перейти к следующей итерации цикла, т.е. вызвать этот же метод у другого студента.
 */
...
//        String geNum = RandomStringUtils.randomAlphanumeric(17).toUpperCase();
    ...
    /**
     * Создать массив с заданиями. Постарайтесь создать массив длины больше 30 и обязательно добавьте
     * туда задания всех типов.
     * (Вы же помните, что это можно реализовать с помощью цикла?)
     */
